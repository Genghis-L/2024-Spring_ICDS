    ...
    def handle_msg(self, from_sock):
        ...
        if len(msg) > 0:
            ...
            # ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                """
                Finding the list of people to send to and index msg
                """
                # IMPLEMENTATION
                # ---- start your code ---- #
                the_guys = self.group.list_me(from_name)
                content = text_proc(msg["msg"], from_name)
                # ---- end of your code --- #
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index(content)
                    mysend(
            ...
            # ==============================================================================
                ...
                # ---- start your code ---- #
                search_rslt = '\n'.join(
                    [x[-1] for x in self.indices[self.logged_sock2name[from_sock]].search(msg["target"])])
