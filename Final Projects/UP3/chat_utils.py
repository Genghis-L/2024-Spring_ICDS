...
menu = "\n++++ Choose one of the following commands\n \
        delay_accumulator: calendar delay_accumulator in the system\n \
        who: to find out who else are there\n \
        c _peer_: to connect to the _peer_ and chat\n \
        ? _term_: to search your chat logs where _term_ appears\n \
        prime1 _#_: to get number <#> sonnet\n \
        prime2: to leave the chat system\n\n"
...
def mysend(s, msg):
    #append size to msg and send it
...
def text_proc(text, user):
    ...
    return('(' + ctime + ') ' + user + ' : ' + text) # msg goes directly to screen
