    ...
    def proc(self, my_msg, peer_msg):
        ...
        if self.state == S_LOGGEDIN:
            ...
            if len(my_msg) > 0:
                ...
                elif my_msg[0] == 'prime1' and my_msg[1:].isdigit():
            ...
            if len(peer_msg) > 0:
                ...
                if peer_msg["action"] == "connect":
                    ...
                    self.peer = peer_msg["from"]
                    self.out_msg = f'Chat request from {self.peer}\nYou are connected with {self.peer}. ' \
                                   f'You could start chatting right now.\n\n------------------------------------\n'
                    self.state = S_CHATTING
                    # ----------end of your code----#
        ...
        # ==============================================================================
            ...
            if len(my_msg) > 0:  # my stuff going out
                mysend(self.s, json.dumps(
                    {"action": "exchange", "from": "[" + self.me + "]", "msg": my_msg}))
                if my_msg == 'bye':
                    self.disconnect()
            ...
            if len(peer_msg) > 0:  # peer's stuff, coming in
                ...
                if peer_msg["action"] == "connect":
                    ...
                    self.out_msg += peer_msg["from"] + peer_msg["msg"]
