    ...
    def handle_msg(self, from_sock):
        ...
        if len(msg) > 0:
            ...
            # ==============================================================================
                            ...
                            json.dumps(
                                {
                                    ...
                                    "message": "",
                                    "status": "fail",
                                    "results": "[Server]: Unable to start! Too many players!",
                                }
                            ),
                        )
                    if numbers == 2:
                ...
                if (
                    self.win(self.gameinfo[groupnum][2], self.gameinfo[groupnum][3])
                    and self.gameinfo[groupnum][3] == "X"
                ):
                    for g in The_guys:
                        to_sock = self.logged_name2sock[g]
                        mysend(
                    ...
                    self.win(self.gameinfo[groupnum][2], self.gameinfo[groupnum][3])
                    and self.gameinfo[groupnum][3] == "O"
                ):
                    for g in The_guys:
                        to_sock = self.logged_name2sock[g]
                        mysend(
